  ...
  return (
    <>
      ...
      <div className="flex justify-end max-[1024px]:justify-start">
        <button
          type="button"
          className="group h-10 cursor-pointer inline-flex w-fit self-start items-center gap-3 border border-[#00112233] bg-transparent px-6 py-2 text-sm font-medium leading-[1.428] text-[#001122] transition-all duration-300 hover:bg-[#001122] hover:text-white hover:border-[#001122]"
        >
          Voir plus
