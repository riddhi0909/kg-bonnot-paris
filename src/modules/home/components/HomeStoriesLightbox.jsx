...
export function HomeStoriesLightbox({ items }) {
  const storyItems = useMemo(() => items || [], [items]);
    ...
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50">
          ...
          <div className="relative mx-auto flex h-full w-full max-w-[1440px] items-center justify-center px-4">
