          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div className="flex h-full flex-col">
                <div className="block bg-[rgba(255,255,255,0.1)] cursor-pointer"
                onClick={() => {
                  setSelectedIndex(index);
                  setOpen(true);
                }}
                ...
                <div className="flex flex-col h-full gap-[30px] border-t border-[rgba(0,17,34,0.2)] p-[15px] text-left" onClick={(e) => e.stopPropagation()}>
                  <div className="mt-[15px] flex items-center justify-between gap-[10px]">
                    <Link href={item.href} className="no-underline">
                      <h3 className="font-serif text-[21px] font-normal leading-[25px]
                          text-[#001122]
                  ...
                  <Link
                    ...
                    >
                    {explorerLabel}
                    <svg className="shrink-0 transition-transform duration-300 hover:translate-x-1" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                      <path d="M0 6.35352H12M12 6.35352L6 0.353516M12 6.35352L6 12.3535" stroke="currentColor" strokeOpacity="0.85" strokeMiterlimit="10" />
                    </svg>
                  </Link>
                </div>
